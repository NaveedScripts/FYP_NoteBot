...
@section('content')
    ...
    <div class="textarea_container m-5">
        <textarea id="tinymceTextarea">{{ isset($book->content->content) ? $book->content->content : '' }}</textarea>
        <div class="notification" id="notification"></div>
    </div>
    <div class="share-button" onclick="copyToClipboard('{{ route('share') }}?book={{ $_GET['book'] }}')"></div>
                    ...
                    $(document).on('click', '#saveButton', function() {
                        ...
                        fetch(fileBlob)
                            ...
                            .then(blob => {
                                ...
                                formData.append('content', "{{ $book->content->id }}");
