    ...
    <div class="row container" style="margin:auto; margin-top: 10%;">
        <div class="col-md-6 all-center">
            ...
            <div class="d-flex" style="align-items:center;gap:10px;">
                <h1 class="bold">AI</h1>
                <h2 class="bold" style="color:white !important">Notes Taking Assistant</h2>
            </div>
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\final_year_project\resources\views/introduction.blade.php ENDPATH**/ ?>