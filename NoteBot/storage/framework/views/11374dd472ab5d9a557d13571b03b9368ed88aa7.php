            ...
            <div class="card-deck">
                <div class="card">
                    <div class="card-body"
                        ...
                        <h4 class="card-subtitle mb-2 bold" style="color: #c0b7e8 !important;">New Noot Book</h4>
                    </div>
                </div>
            </div>
        </a>
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\final_year_project\resources\views/dashboard.blade.php ENDPATH**/ ?>